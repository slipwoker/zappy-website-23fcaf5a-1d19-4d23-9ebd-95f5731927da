  ...
  if (contactForm) {
    ...
    function showFieldError(field, message) {
      ...
      if (!errorEl) {
        ...
        errorEl.id = field.id ? field.id + '-error' : 'error-' + Date.now();
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      // Simulate form submission (replace with actual fetch/XHR as needed)
      ...
      // If a real endpoint is provided via data-action, use fetch
      const actionUrl = contactForm.dataset.action || contactForm.action;
      ...
      if (actionUrl && actionUrl !== window.location.href) {
        ...
        // No endpoint — just show success state
        setTimeout(function () {
          contactForm.classList.remove(FORM_SENDING_CLASS);
          if (submitBtn) {
            submitBtn.disabled = false;
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '23fcaf5a-1d19-4d23-9ebd-95f5731927da',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '23fcaf5a-1d19-4d23-9ebd-95f5731927da';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '23fcaf5a-1d19-4d23-9ebd-95f5731927da';
